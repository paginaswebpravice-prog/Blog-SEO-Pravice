    ...
    <main className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.description}>
          Aprende cómo crear una empresa legalmente en Colombia, los requisitos,
          costos y pasos clave para formalizar tu negocio en Bogotá y el resto
          del país.
        </p>
      </section>
      ...
      <section>
        <p className={styles.text}>
          La constitución de empresas en Colombia es un proceso fundamental para
          cualquier emprendedor que quiera operar de manera legal y segura. En
          ciudades como Bogotá, donde el ecosistema empresarial es altamente
          competitivo, formalizar un negocio no solo es una obligación legal,
          sino una ventaja estratégica.
        </p>

        <p className={styles.text}>
          Crear una empresa correctamente desde el inicio evita problemas
          futuros, facilita el acceso a créditos y permite establecer relaciones
          comerciales formales con clientes y proveedores.
        </p>
        ...
        <p className={styles.text}>
          Constituir una empresa implica crear una persona jurídica diferente de
          sus socios, con derechos y obligaciones propias. Esto permite separar
          el patrimonio personal del empresarial y reducir riesgos legales.
        </p>
        ...
        <p className={styles.text}>
          En Bogotá, estos trámites se pueden realizar de forma presencial o en
          línea, dependiendo del tipo de empresa y la Cámara de Comercio.
        </p>
        ...
        <p className={styles.text}>
          Los costos pueden variar dependiendo del tipo de sociedad y el capital
          registrado. Generalmente incluyen:
        </p>
        ...
        <p className={styles.text}>
          ...
          asesoría jurídica permite evitar errores en la redacción de estatutos,
          elegir la estructura correcta y cumplir con todas las obligaciones
      ...
      <section className={styles.cta}>
        <div className={styles.ctaContent}>
          ...
          <p className={styles.ctaText}>
            Si estás pensando en constituir una empresa en Colombia, contar con
            asesoría legal puede facilitar todo el proceso y evitar errores.
          </p>
