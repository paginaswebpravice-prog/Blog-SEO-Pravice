  ...
  return (
    <>
      ...
      <main className={styles.container}>
        ...
        <p className={styles.text}>
          En ciudades como Bogotá, muchas empresas enfrentan problemas de flujo
          de caja debido a clientes morosos, lo que hace indispensable contar
          con mecanismos legales eficaces para gestionar la cartera.
        </p>
        ...
        <p className={styles.text}>
          En esta fase se intensifican las gestiones de cobro, advirtiendo sobre
          posibles acciones legales si no se cumple con la obligación.
        </p>

        <h3 className={styles.subheading}>Cobro jurídico</h3>
        <p className={styles.text}>
          Cuando no se logra un acuerdo, se inicia un proceso judicial para
          exigir el pago de la deuda, generalmente mediante procesos ejecutivos.
        </p>
        ...
        <p className={styles.text}>
          Estos procesos permiten solicitar medidas como el embargo de bienes o
          cuentas, lo que aumenta significativamente las probabilidades de
          recuperación.
        </p>
        ...
        <p className={styles.text}>
          ...
          estrategias de cobro desde etapas tempranas para evitar que las deudas
