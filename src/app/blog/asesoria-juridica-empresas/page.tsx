      ...
      <main className={styles.container}>
        ...
        <section>
          ...
          <p className={styles.text}>
            ...
            actividad económica del país, muchas empresas optan por contar con
            asesoría legal permanente para prevenir conflictos y optimizar sus
            operaciones.
          </p>
          ...
          <p className={styles.text}>
            Tener respaldo legal permite a las empresas operar con mayor
            seguridad y reducir la probabilidad de enfrentar problemas legales.
          </p>
          ...
          <p className={styles.text}>
            Fundamental para la gestión de empresas, incluye contratos,
            sociedades y relaciones comerciales.
          </p>
          ...
          <p className={styles.text}>
            ...
            empresarial. Es importante evaluar opciones que ofrezcan
            experiencia, enfoque práctico y conocimiento del entorno legal.
          </p>
