    ...
    <>
      ...
      <main className={styles.container}>
        <p className={styles.text}>
          Los contratos comerciales en Colombia son una herramienta fundamental
          para regular las relaciones entre empresas, proveedores y clientes. Un
          contrato bien estructurado no solo establece obligaciones, sino que
          también protege los intereses de las partes involucradas.
        </p>
        ...
        <p className={styles.text}>
          En Colombia existen firmas legales especializadas en derecho comercial
          que ofrecen servicios de elaboración y revisión de contratos.
        </p>

        <p className={styles.text}>
          Si estás evaluando opciones, puedes conocer una firma que brinda este
          tipo de asesoría a continuación.
        </p>
