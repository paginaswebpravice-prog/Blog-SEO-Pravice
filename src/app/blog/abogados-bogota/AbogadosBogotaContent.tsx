      ...
      <main className={styles.container}>
        ...
        >
          <p className={styles.text}>
            ...
            defensa de los derechos de las personas y empresas. En una ciudad
            como Bogotá, donde se concentran gran parte de las actividades
            económicas y comerciales del país, contar con asesoría legal
            adecuada puede marcar la diferencia entre el éxito y el fracaso de
          ...
          <p className={styles.text}>
            En Bogotá existen múltiples firmas de abogados con diferentes
            niveles de experiencia. Es recomendable evaluar opciones con enfoque
            integral y soluciones adaptadas a cada caso.
          </p>
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              headline:
                "Abogados en Bogotá: qué hacen, tipos y cómo elegir el mejor",
              description:
                "Guía completa sobre abogados en Bogotá Colombia, funciones, tipos y recomendaciones.",
              author: {
                "@type": "Organization",
