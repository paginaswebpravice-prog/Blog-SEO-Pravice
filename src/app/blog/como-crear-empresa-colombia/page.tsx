    ...
    <main className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.description}>
          Descubre los pasos clave para crear una empresa en Colombia, desde la
          idea inicial hasta su formalización legal en Bogotá y el resto del
          país.
        </p>
      </section>
      ...
      <section>
        <p className={styles.text}>
          Crear una empresa en Colombia es una de las decisiones más importantes
          para cualquier emprendedor. Más allá de tener una buena idea de
          negocio, es fundamental cumplir con los requisitos legales para operar
          de manera segura y evitar problemas en el futuro.
        </p>

        <p className={styles.text}>
          En ciudades como Bogotá, donde existe un entorno empresarial dinámico,
          formalizar tu empresa te permite acceder a oportunidades de
          crecimiento, alianzas comerciales y financiamiento.
        </p>
        ...
        <h3 className={styles.subheading}>4. Registro en Cámara de Comercio</h3>
        <p className={styles.text}>
          Aquí se formaliza la empresa legalmente. En Bogotá, este proceso puede
          hacerse de forma presencial o virtual.
        </p>
        ...
        <p className={styles.text}>
          Es necesario para manejar las finanzas de la empresa de forma separada
        ...
        <p className={styles.text}>
          ...
          futuro, por lo que es importante hacer el proceso correctamente desde
          el inicio.
        </p>
        ...
        <p className={styles.text}>
          El costo depende del tipo de empresa y del capital registrado. Incluye
          principalmente derechos de registro en Cámara de Comercio, impuestos y
        ...
        <p className={styles.text}>
          ...
          por lo que crear una empresa en esta ciudad ofrece múltiples ventajas
          en términos de mercado, talento y oportunidades.
        </p>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaContent}>
          ...
          <p className={styles.ctaText}>
            Existen firmas legales que pueden acompañarte en todo el proceso de
            creación de empresa, desde la constitución hasta la asesoría
            estratégica.
          </p>
