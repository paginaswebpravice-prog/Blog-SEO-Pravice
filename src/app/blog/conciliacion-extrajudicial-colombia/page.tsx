    ...
    <main className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <p className={styles.description}>
          Conoce cómo la conciliación extrajudicial permite resolver conflictos
          legales en Colombia sin necesidad de acudir a un proceso judicial.
        </p>
      </section>
      ...
      <section>
        <p className={styles.text}>
          La conciliación extrajudicial en Colombia es un mecanismo alternativo
          de resolución de conflictos que permite a las partes llegar a un
          acuerdo sin necesidad de iniciar un proceso judicial. Este mecanismo
          es cada vez más utilizado en ciudades como Bogotá debido a su rapidez,
          eficiencia y menor costo.
        </p>

        <p className={styles.text}>
          En muchos casos, la conciliación no solo es una opción, sino un
          requisito obligatorio antes de acudir a la vía judicial, especialmente
          en temas civiles y comerciales.
        </p>
        ...
        <p className={styles.text}>
          No todos los conflictos pueden resolverse por esta vía, pero en muchos
          casos es el primer paso antes de acudir a un juez.
        </p>
        ...
        <p className={styles.text}>
          En algunos casos, sí. La ley colombiana establece que ciertos procesos
          requieren intentar una conciliación antes de acudir a la vía judicial,
        ...
        <p className={styles.text}>
          En Bogotá existen múltiples centros de conciliación autorizados donde
          puedes iniciar este proceso. Además, muchas firmas legales ofrecen
          acompañamiento para aumentar las probabilidades de éxito en la
          negociación.
        </p>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaContent}>
          ...
          <p className={styles.ctaText}>
            ...
            conciliación para ayudarte a lograr acuerdos favorables sin acudir a
            juicio.
          </p>
